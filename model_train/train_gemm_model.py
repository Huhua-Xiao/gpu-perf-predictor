...
# 4. Evaluation
# =========================
def plot_feature_importance(model, feature_names, out_path="xgb_feature_importances_gemm.png"):
...
def main():
    ...
    plot_feature_importance(best_xgb_model, X_train.columns, out_path="xgb_feature_importances_gemm.png")

    # 6. Evaluate on test set
    evaluate_model(best_xgb_model, X_test, y_test, name="XGBoost")

    # 7. Save model to disk
    model_filename = "xgboost_gpu_perf_predictor_model_gemm.joblib"
