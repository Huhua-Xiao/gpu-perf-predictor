...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Output directory for models and results. If not specified, will auto-detect from dataset filename (e.g., output_GEMM_20k for gemm_dataset_train_20k.csv)"
    )
    ...
    if args.output_dir is None:
        ...
        if "10k" in dataset_basename or dataset_basename == "gemm_dataset_train.csv":
            output_subdir = "output_GEMM_10k"
        elif "20k" in dataset_basename:
            output_subdir = "output_GEMM_20k"
        elif "30k" in dataset_basename:
            output_subdir = "output_GEMM_30k"
        else:
            output_subdir = "output_GEMM"
    ...
    print(f"=" * 80)
    print(f"GPU GEMM Performance Predictor - Training Log")
